...
pub fn create_bsc_block_executor<'a>(
    db: &'a mut State<CacheDB<EmptyDB>>,
    header: &'a Header,
) -> BscBlockExecutor<'a, BscEvm<&'a mut State<CacheDB<EmptyDB>>, NoOpInspector, PrecompilesMap>, Arc<BscChainSpec>, RethReceiptBuilder> {
    // 1. 创建链规范
